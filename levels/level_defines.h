...
DEFINE_LEVEL("BATTLE FIELD", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x04, 0x00, 0x00, _, sCamBOB) 
...
DEFINE_LEVEL("MAIN MAP", LEVEL_CASTLE_GROUNDS, COURSE_NONE, castle_grounds, outside, 20000, 0x04, 0x00, 0x00, _, sCamCastleGrounds) 
